/**
 * Standard Error Types for Autonav Communication Layer
 *
 * These errors represent common failure modes in the navigation system.
 */

/**
 * Base class for all Autonav errors
 */
export class AutonavError extends Error {
 ...
 */
export class SourceNotFoundError extends AutonavError {
 ...
 */
export class LowConfidenceError extends AutonavError {
 ...
 */
export class OutOfDomainError extends AutonavError {
 ...
 */
export class ContextOverflowError extends AutonavError {
 ...
 */
export class HallucinationError extends AutonavError {
 ...
 */
export class VersionMismatchError extends AutonavError {
 ...
 */
export class ValidationError extends AutonavError {
